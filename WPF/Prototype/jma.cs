...
namespace Prototype {
    ...
    public class Results2 {
        public string api_version { get; set; }
        public Large_Area2[] large_area { get; set; }
        public int results_available { get; set; }
        public string results_returned { get; set; }
        public int results_start { get; set; }
    }

    public class Large_Area2 {
        public string code { get; set; }
        public Large_Service_Area2 large_service_area { get; set; }
        public string name { get; set; }
        public Service_Area2 service_area { get; set; }
    }

    public class Large_Service_Area2 {
        public string code { get; set; }
        public string name { get; set; }
    }

    public class Service_Area2 {
        public string code { get; set; }
        public string name { get; set; }
    }

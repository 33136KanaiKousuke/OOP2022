...
namespace SampleUnitConverter {
    public class MainWindowViewModel : ViewModel {
        private double mtricValue, impererialValue;

        public double MetricValue {
            get { return this.mtricValue; }
            set{this.mtricValue = value;
                this.OnPropertyChanged();
            }
        }

        public double ImperialValue {
            get { return this.impererialValue; }
            set{this.impererialValue = value;
                this.OnPropertyChanged();
            }
        }
